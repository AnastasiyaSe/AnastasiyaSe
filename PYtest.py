...
class TestSomething:
    ...
    def test_doc_owner_name(self, number, name):
    ...
    @pytest.mark.parametrize('user_doc_number, shelf',[("2207 876234",'1'),('10006','2')])
    def test_get_doc_shelf(self,user_doc_number,shelf):
        assert get_doc_shelf(user_doc_number) == shelf
    ...
    @pytest.mark.parametrize('new_doc_number, new_doc_type, new_doc_owner_name, new_doc_shelf_number',[('12345', 'pass','marat oli','3')])
    def test_add_new_doc(self, new_doc_number, new_doc_type, new_doc_owner_name, new_doc_shelf_number):
        assert add_new_doc('12345', 'pass','marat oli','3') == new_doc_shelf_number
    ...
    @pytest.mark.parametrize('user_doc_number',[('12345', True)])
    def test_delete_doc(self,user_doc_number):
        assert delete_doc('12345') == user_doc_number
